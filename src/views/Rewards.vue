                  ...
                  <div class="media-left">
                    ...
                    <div class="media-content">
                      <div class="column" style="text-align:left!important">
                        ...
                        <p class="title is-5">{{ stats.earnings[node] }} BDCASH at next payout</p>
                      </div>
                    </div>
                  </div>
                </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      async fetchStats(){
        const app = this
        let stats = await axios.get('https://pool.bdcashprotocol.com/status')
